    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html","/login", "/signup","/signupWithImage", "/post/image/**", "/category", "/forgot-password/**", "/posts", "category/{categoryId}/posts", "post/{postId}", "like/{postId}/likeCount", "like/{postId}/disLikeCount", "/comments-post/{postId}" , "/{postId}/commentCount")
                        .permitAll()
